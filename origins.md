...
- *Modularity Emerges from Action-Functional Constraints* (Frasch 2026d, arXiv preprint in submission) — biology-scale validation in marine metagenomic networks. Code and data: [github.com/martinfrasch/tara-modularity](https://github.com/martinfrasch/tara-modularity). **[Read →]({{ '/validation/biology/' | relative_url }})**
